// show extended form
let extendBtn = document.getElementById("extendButton");
let extendedForm = document.getElementById("extendedForm");

extendBtn.addEventListener("click", () => {
  console.log("clicked");
  extendedForm.style.cssText = "display: block ";
});
...
$(function () {
  ...
  $("#exampleModal").on("hidden.bs.modal", function (event) {
    extendedForm.style.cssText = "display: none";
  });
